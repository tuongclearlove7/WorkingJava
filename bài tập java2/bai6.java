...
public class Bai6 {
    ...
    public static void dao_tu_chuoi(String str){
        ...
        String[] myString;
        myString = str.split(" ");
        for(int i=myString.length-1;i>=0;i--) System.out.print(myString[i]+" ");
    }

    public static void main(String[] args) {

        Java1 tao_ham = new Java1();
        Scanner nhap = new Scanner(System.in);  
        System.out.print("nhap : ");
        String str = nhap.nextLine();  
        System.out.print("so tu trong chuoi la : "+ dem_tu(str));
        System.out.print("\nso ky tu dac biet la : "+tao_ham.dem_kytu(str));
        System.out.print("\nchuoi dao nguoc la : ");
        tao_ham.dao_cuoi(str);
        System.out.print("\ndao nguoc tu trong chuoi la : ");
        tao_ham.dao_tu_chuoi(str);
