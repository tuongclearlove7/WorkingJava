...
public class Pratice_ReplaceString_20 {
    ...
    public static void main(String[] args) {
        ...
        String str = "tuong    yeu   thao   nhieu   lam";
        System.out.print("Input : " + str);
        String StringNoSpace = "tuongyeuthaonhieulam";
        ...
        Algorihm_Count_Character(str, CharSPACE);
        Algorihm_Count_Character(str,'t');
        Algorihm_Count_Character(str,'u');
        Algorihm_Count_Character(str,'o');
        Algorihm_Count_Character(str,'n');
        Algorihm_Count_Character(str,'g');
        Algorihm_Count_Character(str,'n');
        Algorihm_Count_Character(str,'h');
        Algorihm_Count_Character(str,'i');
        Algorihm_Count_Character(str,'l');
        Algorihm_Count_Character(str,'a');
        Algorihm_Count_Character(str,'m');
