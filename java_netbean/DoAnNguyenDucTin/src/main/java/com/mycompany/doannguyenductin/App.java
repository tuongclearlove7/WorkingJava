...
public class App extends JFrame{
    ...
    public App(){
        ...
        ActionListener listener1 = new add(this);
        ...
        ActionListener listener_clean = new clean();
        ...
        ActionListener listener_check = new check();
        ...
        ActionListener listener_WriteFile = new saveTofile();
        ...
        ActionListener listener_ReadFile = new readTofile();
